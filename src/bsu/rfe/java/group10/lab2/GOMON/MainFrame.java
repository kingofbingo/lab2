package bsu.rfe.java.group10.lab2.GOMON;
...
hboxVariables.add(Box.createHorizontalStrut(300)); // Добавить «распорку» C2-H3 шириной 100 пикселов для отступа между текстовым полем для ввода X и подписью для Y
...
hboxResult.setBorder(BorderFactory.createLineBorder(Color.RED)); // Задать рамку для контейнера
...
color.red - Данный веб-сайт выставлен на..
Color.RED
JOptionPane.WARNING_MESSAGE); // В случае исключительной ситуации показать сообщение
}
}
});
